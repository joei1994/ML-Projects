...
def clean_players(filename, base_filename):
    ...
    """
    headers = ['id', 'first_name', 'second_name', 'team', 'team_code', 'element_type', 'goals_scored', 'assists', 'total_points', 'minutes', 'goals_conceded', 'creativity', 'influence', 'threat', 'bonus', 'bps', 'ict_index', 'clean_sheets', 'red_cards', 'yellow_cards', 'selected_by_percent', 'now_cost']
